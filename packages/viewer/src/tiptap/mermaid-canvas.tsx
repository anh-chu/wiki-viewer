	...
	return (
		...
		>
			<div
				...
				// biome-ignore lint/security/noDangerouslySetInnerHtml: mermaid SVG. This is
				// the one place rendered markup bypasses rehype-sanitize, so the boundary is
				// mermaid's own DOMPurify pass, which only runs because securityLevel is
				// "antiscript" rather than "loose". See the comment in mermaid-code-block.tsx.
